...
def plot_anosim(anosim):
    ...
    ax.set_xlabel('The name of grouping scheme', fontsize=8)
    ax.set_ylabel('R value', fontsize=8)
    ...
    ax.set_title('anosim result of different groups', fontsize=10)
    fig.subplots_adjust(left=0.15, bottom=0.15)
    plt.savefig('anosim_result.svg', format='svg')
    plt.close()
