...
#            f.write('%s\t%s\n' % (i, features_type[i]))
    ...
    for species in features:
        ...
        plt.savefig('find_singlespecies/%s_all.png' % species)
        plt.close()
...
# draw_features(sample_info, set(sample_info['name']), features_type)
# draw_features(sample_info_select, set(sample_info_select['name']), features_type)
if select_features:
    draw_features(sample_info, set(sample_info['name']), features_type, select_features)
